...
public class frmvistaplancha extends javax.swing.JInternalFrame {
    ...
    private void tablalistadoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablalistadoMousePressed
        ...
        if (evt.getClickCount()==2) {
            ...
            cod1=tablalistado.getValueAt(fila, 0).toString();
            valor1=tablalistado.getValueAt(fila, 1).toString() + " " +  tablalistado.getValueAt(fila, 2).toString();
            
            cod2=tablalistado.getValueAt(fila, 0).toString();
            valor2=tablalistado.getValueAt(fila, 1).toString() + " " +  tablalistado.getValueAt(fila, 2).toString();

            
            //if(new frmoperacion().isShowing() || new frmoperacion().isIcon()){
                frmoperacion.txtidplancha.setText(cod);
                frmoperacion.txtplancha.setText(valor);
            //}
            
            //if(new frmopventa().isShowing() || new frmopventa().isIcon()){
                frmopventa.txtidplancha.setText(cod1);
                frmopventa.txtplancha.setText(valor1);
            //}
            

                frmopentrada.txtidplancha.setText(cod2);
                frmopentrada.txtplancha.setText(valor2);
            this.dispose();
